    ...
    <ext:TabPanel ID="TabPanel1" runat="server" ActiveTabIndex="0" Width="700" Height="600"
        ...
        <Items>
            ...
            <ext:Panel ID="Panel2" runat="server" Title="Dynamic Settings" Padding="6" AutoScroll="true">
                <Content>
                    <ext:FieldSet ID="FieldSet2" runat="server" Title="Dynamic Settings" Width="670">
                        <Content>
                            <table class="style1">
                                <tr>
                                    <td>
                                        <asp:HyperLink ID="HyperLink7" ToolTip="Formatting" NavigateUrl="~/Formatting"
                                            ImageUrl="~/Content/images/formatting.png" runat="server" />
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:HyperLink ID="HyperLink13" ToolTip="Queries" NavigateUrl="~/Queries.aspx"
                                            ImageUrl="~/Content/images/Queries.png" runat="server" />
                                    </td>
                                </tr>
                            </table>
                        </Content>
